...
git is a version control system. github is a cloud based hosting service where you can manage your git repositories 

2. Why do we create a branch? 
git checkout -b nameofbranch

3. What is the purpose of a pull request? 
to submit your work to show to someone and see if its ready to be approved

4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
git checkout branchname

5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
git fetch when used grabs changes from your remote repository and adds them to your local copy.
git merge takes changes from one branch and applies them into another.
git pull is used when fetching changes and merging them. Pull will add in changes you made to your local copy so its up to date.

6. What is a merge conflict? How do you resolve a merge conflict? 
a merge conflict is when people make different changes to the same line of the same file or someone edits a file and someone deletes a the file.
you can resolve this by opening the file and making the necessary changes then add, commit, push